export const es = {
    ...
    collaborate: {
        ...
        howWeBuild: {
            title: "Así es como construimos",
            description: "No estamos ofreciendo trabajos, estamos construyendo un equipo de personas que creen antes de que todo esté listo. Si buscas estabilidad, puede que esto no sea para ti. Pero si estás aquí para ayudar a dar forma a algo desde cero, nos encantaría conocerte.",
            cta: "Aplicar"
        }
    },
    contact: {
        title: "Contacta, de la Manera Correcta",
        description: "Diferentes temas, diferentes bandejas de entrada. Aquí tienes cómo contactarme a mí o al equipo de Denail directamente.",
        careers: {
            tag: "Carreras y Candidaturas",
            title: "¿Quieres trabajar con nosotros?",
            description: "Estamos construyendo algo desde cero y buscamos personas increíbles para unirse. Envía tu CV o portafolio aquí.",
            cta: "Colaborar"
        },
        investors: {
        ...
        general: {
            ...
            description: "Ideas, prensa, preguntas, o cualquier cosa que no encaje arriba, escríbeme directamente: denail@gmail.com"
        }
    },
    footer: {
        product: "Producto",
