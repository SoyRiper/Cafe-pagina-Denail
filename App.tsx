...
const App: React.FC = () => {
  ...
  return (
    <LanguageProvider>
      <div className="min-h-screen text-[#0A0A0A] dark:text-white dark:bg-black transition-colors duration-500 overflow-x-hidden bg-site-bg flex flex-col">
        ...
        <AnimatePresence>
          {isLoading && (
            ...
            >
              ...
              >
                <div className="logo-stout text-6xl text-black">DENAIL</div>
